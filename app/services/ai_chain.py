...
This module provides LangChain integration with Google Gemini for AI-powered
conversation management. It handles conversation memory, context preservation,
...
Você tem acesso ao histórico da conversa para fornecer respostas contextualizadas."""
    ...
    def _setup_chain(self):
        ...
        # ✅ Aqui trocamos ("system", self.system_prompt) por ("human", self.system_prompt)
        # para evitar o erro "SystemMessages are not yet supported!"
